...
#chunk.matchPhotos(
#reference_preselection = False, # changed
#filter_stationary_points = False, # changed


#commented out the removePoints() section under Optimize camera alignment

#chunk.buildDepthMaps(
#reuse_depth = False, # changed


# modified out optimize camera locations
...
#source_images = "/scratch1/migomez/3Dmodels/source_images/DRTO_REDO_Dec2025/Adjustables/3s/062823_3B_JP_PS_Y109-rebuild"
...
scalebars_path = "/scratch1/migomez/metashape-pro_1_8_3/Scales/Adjustable3Scale_BARSTICKERS_060123.txt" # THIS IS THE ONLY THING YOU NEED TO CHANGE
...
photoset=glob.glob(cwd+"/*.JPG") # directs metashape to photos to be used to build the model. There is a chance you have to change to .jpg/.JPG
...
chunk.matchPhotos(downscale = 1, keypoint_limit_per_mpx = 300, generic_preselection = False, reference_preselection=False, filter_mask=False, mask_tiepoints=True,
filter_stationary_points=False, keypoint_limit=40000, tiepoint_limit=4000, keep_keypoints=False, guided_matching=False,
...
#reconun = float(50) # loosen threshold for low coverage models or omit alltogether
#projecac = float(25)
...
# If we comment out chunk.optimizeCameras entirely then it tosses the scalebar error stats ---- need the tiepopint_covariance to enable scalebar error.
# Some other changes as well for rescued photosets.
chunk.optimizeCameras(fit_f=True, fit_cx=True, fit_cy=True, fit_b1=False, fit_b2=False, fit_k1=True, fit_k2=True, fit_k3=True,
fit_k4=False, fit_p1=True, fit_p2=True, fit_corrections=True, adaptive_fitting=False, tiepoint_covariance=True)
...
#chunk.buildDepthMaps(downscale = 2, filter_mode = Metashape.MildFiltering, reuse_depth = False, max_neighbors=16, subdivide_task=True, workitem_size_cameras=20, max_workgroup_size=100)
