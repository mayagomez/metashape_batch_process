...
## Set file paths:
source_images = "/Volumes/Maya_Frag/frag/images/SinglePolyp/SMPrep/41-E-B"
...
timepoint=array[6]
output=f"/Users/migomez/Desktop/models/{project}/{timepoint}/"


## Point to the scalebar and coordinate files
scalebars_path = '/Users/migomez/Documents/USC/Photogrammetry/Scales:Coords/FragramScale_050625.txt'
FragramCoords = '/Users/migomez/Documents/USC/Photogrammetry/Scales:Coords/FragramCoords_050625.txt'
...
size = (0.13,0.13,0.15) # (width,depth,height)in meters --- CHANGE THIS TO MODIFY THE SIZE OF YOUR BUILD. Used to have 0.1, 0.1, 0.14
angle = 90 # float - rotation angle of the region (in degrees)
...
chunk.exportReport(path = output+swd[-1]+"_report.pdf", title = swd[-1], font_size=12, page_numbers=True)
