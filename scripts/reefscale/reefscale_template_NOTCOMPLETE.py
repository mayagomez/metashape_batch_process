...
# PURPOSE: This script uses provided photosets to build scaled models of entire coral reef plots via command line Agisoft Metashape. 
	# Scales are based on scalebars that are placed down before imaging the reef. Permanent corner markers allow for georeferenceing for subsequent timepoints. 
...
output = "/scratch1/migomez/3Dmodels/models/ORCC_January2023/Reefscale/"
scalebars_path = "/project/ckenkel_26/software/metashape-pro/Scales/MoteScaleBars.txt"
...
chunk.matchPhotos(downscale = 1, keypoint_limit_per_mpx = 300, generic_preselection = True, reference_preselection=False, filter_mask=False, mask_tiepoints=True,
