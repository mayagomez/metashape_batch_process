...
The scripts utilized for batch processing 3D models varies slightly by the image capture method. All models are scaled according to the distances between unique Agisoft Metashape markers in the target region. 
