...
### 3. Generate report
chunk.exportReport(path = output+swd[-1]+"_report.pdf", title = swd[-1], description = "Processing report for ORCC October 2022 Rack Model - Timepoint 0", font_size=12, page_numbers=True, include_system_info=True)
