...
TIMEPOINT=$1
TEMPLATE=adjustables_template_rescue3.py	# Option to change this to the template script of your choosing.
ADJUSTABLE=$2
...
mkdir /scratch1/migomez/metashape-pro_1_8_3/ToRun/$TIMEPOINT/Adjustables/$ADJUSTABLE          # Option to change this locatio
OUT=/scratch1/migomez/metashape-pro_1_8_3/ToRun/$TIMEPOINT/Adjustables/$ADJUSTABLE              # Option to change this location.

# Create an output directory for the 3D models to be saved to (for this batch).
mkdir /scratch1/migomez/3Dmodels/models/$TIMEPOINT/Adjustables/$ADJUSTABLE
