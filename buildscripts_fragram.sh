...
DIR=/scratch1/migomez/3Dmodels/source_images/Fragram/$TIMEPOINT	# Option to change this location. All you should need to do is change migomez to your username.



# Create an output directory based on the timepoint directory name and save all subsequent outputs here. 
mkdir /project/ckenkel_26/software/metashape-pro/ToRun/Fragram/$TIMEPOINT          # Option to change this location.
OUT=/project/ckenkel_26/software/metashape-pro/ToRun/Fragram/$TIMEPOINT     	# Option to change this location.
...
for i in `ls ToRun/Fragram/$TIMEPOINT/*.py`; do		# This could also be done as follows: for i in `cat $OUT/listofscripts.txt`; do 
...
cat template_MetashapeJobSubmit.slm $OUT/ToDo.txt > Fragram_${TIMEPOINT}_MetashapeJobSubmit.slm
chmod +x Fragram_${TIMEPOINT}_MetashapeJobSubmit.slm
