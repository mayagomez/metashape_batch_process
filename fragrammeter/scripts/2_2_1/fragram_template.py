...
#center = (0,0,0.02) # (X,Y,Z) in CRS coordinates --- this is the normal one
center = (0,0,0) # (X,Y,Z) in CRS coordinates --- tyring this for the ofavs (less head space)
#center = (0,0,0.087) # swap to this for autotrimming
#size = (0.13,0.13,0.15) # (width,depth,height) in meters --- CHANGE THIS TO MODIFY THE SIZE OF YOUR BUILD --- use this for larger live corals (Used for this for all single polyp and fragram paper work)
#size = (0.1,0.1,0.14) # Use this for small frags (ex. skeletons for physiology and ofavs)
